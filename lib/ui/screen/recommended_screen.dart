...
class RecommendedScreen extends StatefulWidget {
  const RecommendedScreen(
      ...
      required this.recommendedOtherUsers});
  final VoidCallback setUpInit;
  final List<Map<String, dynamic>> recommendedOtherUsers;
  @override
    ...
    return SafeArea(
        child: isLoading
            ...
            : GridView.builder(
                ...
                itemCount: widget.recommendedOtherUsers!.length,
                itemBuilder: (context, index) {
                  return _buildImageTile(widget.recommendedOtherUsers!, index);
                },
              ));
  }
